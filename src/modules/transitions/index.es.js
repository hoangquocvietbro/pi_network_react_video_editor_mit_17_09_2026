...
var fe;
function Fe() {
  return fe || (fe = 1, PUBLIC_ENV.NODE_ENV !== "production" && function () {
    function e(n) {
...
PUBLIC_ENV.NODE_ENV === "production" ? se.exports = Pe() : se.exports = Fe();
var i = se.exports;
